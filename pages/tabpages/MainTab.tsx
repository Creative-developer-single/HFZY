...
function HfClothesShow() {
    ...
    return (
        <TouchableOpacity style={MainTabStyle.ClothesShowStyle} activeOpacity={1} onPress={Enter3DClothes}>
            <Image source={require('../../Img/temp/女褂.jpg')} style={{ width: '90%', height: '100%', resizeMode: 'contain' }}></Image>
        </TouchableOpacity>
    )
}
    ...
    return (
        <View style={{ display: 'flex', flexDirection: 'row', height: 50, width: '80%', marginLeft: 40, marginTop: -8, justifyContent: 'space-evenly' }}>
            <View style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <View>
                    <Image source={require("../../Img/temp/main_clothe.png")} style={MainTabStyle.icon_clothe}></Image>
                </View>
            ...
            <View style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <View>
                    <Image source={require("../../Img/temp/主页图标-其它.png")} style={MainTabStyle.icon_clothe}></Image>
                </View>
